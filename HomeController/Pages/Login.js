                    ...
                    <View style={styles.mainView}>
                        ...
                        <View style={styles.loginView}>
                            ...
                            <View style={{
                                ...
                                >
                                    <Icon name={this.state.secpass ? "eye" : "eye-slash"} size={RFPercentage(2.5)} color="#000" />
                                </TouchableOpacity>
                            </View>
                            ...
                            <Text style={{ color: "#000", alignSelf: "center", fontSize: RFPercentage(2), }}>Or</Text>
                            ...
                            >
                                <Text style={{ color: Constants.mainColor, alignSelf: "center", fontSize: RFPercentage(3), textDecorationLine: 'underline' }}>SignUp</Text>
                            </TouchableOpacity>
